...
public abstract class ItemListBinding extends ViewDataBinding {
  ...
  @Bindable
  protected VenuesAdapterClickListener mClickListener;

  protected ItemListBinding(Object _bindingComponent, View _root, int _localFieldCount,
      TextView distance, TextView name) {
  ...
  public abstract void setClickListener(@Nullable VenuesAdapterClickListener clickListener);

  @Nullable
  public VenuesAdapterClickListener getClickListener() {
