...
public abstract class Hilt_VenuesListFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_VenuesListFragment() {
    super();
  }

  Hilt_VenuesListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((VenuesListFragment_GeneratedInjector) generatedComponent()).injectVenuesListFragment(UnsafeCasts.<VenuesListFragment>unsafeCast(this));
  }
